package org.chronos.lol.api.services.V2_1
...
import org.chronos.lol.api.services.V2_1.protocol.LeagueProtocol._
import org.chronos.lol.api.services.V2_1.models.League
...
object LeagueService {
   def GetLeagueData(region: Region, id: Long)(implicit key: ApiKey, ec: ExecutionContext) : Future[Map[String, League]] = {
     val urlString = "https://prod.api.pvp.net/api/" + region.toString + "/v2.1/league/by-summoner/" + id + "?api_key=" + key.getKey()
